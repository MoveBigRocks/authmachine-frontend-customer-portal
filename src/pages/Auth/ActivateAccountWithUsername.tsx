...
import {ActivateAccountWithUsernameProps} from "../../interfaces/auth/activateAccountWithUsername";

const { Step } = Steps;

const ActivateAccountWithUsername = (props: ActivateAccountWithUsernameProps) => {
    const {activationFirstStepStatus, activationSecondStepStatus, message} = props;
    ...
    const onSecondFinish = (values: any) => props.activationSecondStep(values);
    ...
    return (
        <div className="form-container auth-form">
            ...
            <ul className="additional-actions">
                <li>Got activation code without username? <Link to="/activation">Activate account</Link></li>
            </ul>
        </div>
    )
};
